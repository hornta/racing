...
public enum MessageKey {
  ...
  RACE_ADD_CHECKPOINT_POSITION_OUT_OF_BOUNDS,
  RACE_DELETE_CHECKPOINT_SUCCESS,
  RACE_MOVE_CHECKPOINT_SUCCESS,
  RACE_MOVE_CHECKPOINT_NO_CHANGE,
  RACE_MOVE_CHECKPOINT_OCCUPIED,
  RACE_ADD_STARTPOINT_SUCCESS,
  RACE_ADD_STARTPOINT_IS_OCCUPIED,
  RACE_ADD_STARTPOINT_POSITION_OUT_OF_BOUNDS,
  RACE_DELETE_STARTPOINT_SUCCESS,
  RACE_MOVE_STARTPOINT_SUCCESS,
  RACE_MOVE_STARTPOINT_NO_CHANGE,
  RACE_MOVE_STARTPOINT_OCCUPIED,
  ...
  RACE_SET_WALKSPEED,
  RACE_SET_PIG_SPEED,
  RACE_SET_ELYTRA_SPEED,
  RACE_SET_STRIDER_SPEED,
  ...
  RACE_TOP_ITEM_NONE,
  RACE_RESET_TOP,
  HD_TOP_LIST_CREATE_SUCCESS,
  HD_TOP_LIST_CREATE_ERROR_NO_PERSIST,
  HD_TOP_LIST_CREATE_ALREADY_EXIST,
  HD_TOP_LIST_DELETE_SUCCESS,
  HD_TOP_LIST_DELETE_ERROR_FAIL_DELETE_FILE,
  HD_TOP_LIST_MOVE,
  HD_TOP_LIST_SET_RACE,
  HD_TOP_LIST_SET_STAT,
  HD_TOP_LIST_SET_LAPS,
  HD_TOP_LIST_LIST_HEADER,
  HD_TOP_LIST_LIST_ITEM,
  HD_TOP_LIST_LIST_ITEM_INFO,
  HD_TOP_LIST_LIST_TELEPORT_CLICK,
  HD_TOP_LIST_LIST_TELEPORT_HOVER,
  RACE_NOT_FOUND,
  RACE_ALREADY_EXIST,
